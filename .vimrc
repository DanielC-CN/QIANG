...
" License: MIT
"
" Custimozed by Daniel 2020-12-17
"
...
set nofoldenable         " 折叠代码
set foldmethod=manual    " manual 折叠代码

"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" 代码补全
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
set wildmenu             " vim自身命名行模式智能补全
set wildmode=full        " by default, it's full
...
if has("gui_running")
    ...
    if system == "Darwin\n"
        set guifont=MesloLGS\ NF:h13 " 设置字体
    else
        set guifont=MesloLGS\ NF\ \ Regular\ 13      " 设置字体
    endif
    ...
    set guioptions+=c           " confirm in GUI
    set showtabline=0           " 隐藏Tab栏

	let output =  system("defaults read -g AppleInterfaceStyle")
	if v:shell_error != 0
    	set background=light
        colorscheme espresso-tutti
    else
    	set background=dark
        " colorscheme onedark
        colorscheme dracula
...
" autocmd! bufwritepost vimrc source $MYVIMRC  "seems not working
